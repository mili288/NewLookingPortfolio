...
import Assistant from '../img/OES.png';
...
export const info = {
  ...
  portfolio: [
    ...
    {
      title: 'Full-Stack Voice AI Assistant',
      live: 'https://644f7f59ff7a0d6e7719e110--magical-trifle-24839d.netlify.app/', //this should be a link to the live version of your project, think github pages, netlify, heroku, etc. Or your own domain, if you have it.
      source: 'https://github.com/mili288/AI-Assistant', // this should be a link to the **repository** of the project, where the code is hosted.
      image: Assistant,
    },
    {
